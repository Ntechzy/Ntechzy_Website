...
const ClientFeedback = () => {
  return (
    <div className='text-white py-8 px-4'>
      ...
      <div className='text-center mb-8 font-bold text-3xl md:text-4xl'>
        ...
        <div className='bg-gray-900 p-6 rounded-lg flex flex-col items-center'>
          ...
          <div className='flex justify-between items-center w-full mb-4'>
            ...
            <div className='flex items-center ml-4'>
              <img src='https://gaaga.wpengine.com/wp-content/uploads/2023/06/home-testimonial-4.png' alt='Client 1' className='rounded-full w-12 h-12 md:w-16 md:h-16 mb-2 mr-2' />
