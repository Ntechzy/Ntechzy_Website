  ...
  return (
    <div className='bg-cover bg-center h-screen flex flex-col justify-between p-4 lg:p-8'>
      <div className='flex flex-col lg:flex-row gap-6'>
        {/* Social Media Icons */}
        <div className='flex lg:flex-col items-center lg:items-start gap-4 lg:gap-6 mt-4 lg:mt-[40px]'>
        ...
        <div className='flex flex-col lg:flex-row items-center lg:items-start flex-grow gap-4 lg:gap-10'>
          ...
          <div className='text-center lg:text-left text-white flex-grow p-4'>
            <span className='block text-lg mt-2 lg:mt-[20px] font-semibold mb-2'>Innovative Ideas</span>
            <h1 className='text-2xl lg:text-4xl font-bold mb-4'>We offer You A digital Platform</h1>
            <p className='max-w-lg mx-auto lg:mx-0 text-sm lg:text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus quasi iusto ratione nemo culpa atque, laudantium ut nostrum consectetur animi quidem error rem impedit at. Dolorum ullam nemo assumenda nam!</p>
          ...
          {/* Image Section */}
          <div className='flex-shrink-0 w-full lg:w-[400px] xl:w-[600px] 2xl:w-[800px] h-auto'>
