    ...
    <div className="text-white p-11">
      ...
      <div className="">
        <p className="p-3" data-aos="fade-down-right">
          ...
          deployment, maintenance, and ongoing support, ensuring that each
          solution we deliver aligns with the unique objectives of our clients.
          Whether it's a robust CRM system for hospitals or a custom LMS for
          educational institutions, our team is equipped to provide scalable and
          secure solutions.
        </p>
        ...
        <p className="p-3"data-aos="fade-down-left">
          ...
          pay-per-click (PPC) advertising, content creation, social media
          management, and analytics. We combine data-driven strategies with
          creative content to maximize our clients' digital presence.
          Additionally, we offer marketing consulting services to help
          businesses align their strategies with market trends and customer
          behavior
        </p>
        ...
        <p className="p-3"data-aos="fade-down-right">
          ...
          running effective digital campaigns, we cover every aspect of your
          brand’s journey.
        </p>
        ...
        <p className="p-3"data-aos="fade-down-left">
          ...
          developers, digital marketing experts, health counselors, marketing
          specialists, and video production managers, work in close coordination
          to provide a seamless experience for our clients. We take pride in
          serving over 50 colleges, universities, hospitals, and political
